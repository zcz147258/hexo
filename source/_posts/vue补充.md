...
description: Vue补充
keywords: Vue补充
top_img: https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=22130535,2850036426&fm=26&gp=0.jpg
...
2.进阶
  ...
  //cnpm install highlight.js --save-dev
  import vuemd from "../../../static/md/vue补充.md";
...
el-form属性
	model	表单数据对象
			:model="ruleForm"  ruleForm={pass: '',checkPass: '',age: ''} 控制
			el-form-item  子表单项目使用 prop="pass"来输入值
	rules	表单验证规则
	
	ref="ruleForm"  操作DOM对象
 ...
 2.定义路由规则
    ...
    Vue.directive('permission',{
        inserted:function(el,binding){
            ...
            //路由对应的组件中的meta字段
            const currentRoutes = route.currentRoute.meta
            if(currentRoutes.indexOf(action) == -1){
                if(effect === 'disabled'){
                	el.disabled = true
